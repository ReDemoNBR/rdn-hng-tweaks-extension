...
function setStorage(){
	...
	chrome.storage.local.set({hide_forum: {sections: sections, subforums: subforums}}, ()=>overlay.parentElement.removeChild(overlay) && window.open(location.origin+location.pathname+"?save=successfully", "_self"));
}
